...
/*
#define STRING_TEXT_AUTOARM  "rearm"
#define STRING_TEXT_VERIFY   "verify"
#define STRING_TEXT_AUTOTEST "autotest"
*/
...
BannPulsDynIcon::BannPulsDynIcon( QWidget *parent, const char *name )
...
#if 0		
			qDebug("Bitmap content starting from b0 to b15");
			for (int i=0; i< 16; i++)
			  qDebug("b%d = %d", i, (statusBmp>>i)&STATUS_BIT_OPEN_CLOSE);
#endif
...
StopngoPage::StopngoPage(QWidget *parent, const char *name, QString where, int id, QString pageTitle)
          : QWidget(parent, name)
{
...
{	
  ...
  titleBar->setFont( tFont/*QFont( "helvetica", 14, QFont::Bold)*/ );
