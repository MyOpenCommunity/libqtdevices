...
static const int bottom_margin = 60;
...
#else
		b->setGeometry(0, bottom_margin + buttons_dim * pos, buttons_dim, buttons_dim);
#endif
		return b;
	}
	return 0;
...
{
#ifdef LAYOUT_TS_10
	return QSize(buttons_dim, buttons_dim * 4 + bottom_margin);
#else
