...
void banner::SetIcons( uchar idIcon, const char *actuallcon )
{
	...
	if (!pressIcon[idIcon])
		pressIcon[idIcon] = this->icons_library.getIcon(&pressIconName[0]);
}
...
void banner::SetIcons( const char *actuallcon ,char tipo)
{
	...
	{	
		...
		if (QFile::exists(pressIconName) && !pressIcon[0])
			pressIcon[0] = this->icons_library.getIcon(pressIconName);
	}
	...
	if (tipo==3)
	{
		...
		if (QFile::exists(pressIconName) && !pressIcon[3])
			pressIcon[3] = icons_library.getIcon(pressIconName);
	}
}
...
void banner::SetIcons( const char *sxIcon , const char *dxIcon)
{
	...
	if (sxIcon)
	{
		...
		if (QFile::exists(pressIconName) && !pressIcon[0])
			pressIcon[0] = icons_library.getIcon(pressIconName);
	}
	...
	if (dxIcon)
	{
		...
		if (QFile::exists(pressIconName) && !pressIcon[1])
			pressIcon[1] = icons_library.getIcon(pressIconName);
	}
}
...
void banner::SetIcons( const char *sxIcon , const char *dxIcon,const char*centerActiveIcon,const char*centerInactiveIcon)
{
	...
	if (centerInactiveIcon)
	{
		...
		if (QFile::exists(pressIconName) && !pressIcon[2])
			pressIcon[2] = icons_library.getIcon(pressIconName);
	}
}
...
void banner::SetIcons( const char *sxIcon , const char *dxIcon,const char*centerInactiveIcon,const char*centerUpIcon,const char*centerDownIcon)
{
	...
	if (sxIcon)
	{
		...
		if (QFile::exists(pressIconName) && !Icon[0])
			Icon[0] = icons_library.getIcon(sxIcon);
	}
	...
	if (centerDownIcon)
	{
		...
		if (QFile::exists(pressIconName) && !pressIcon[4])
			pressIcon[4] = icons_library.getIcon(pressIconName);
	}
}
